...
const BestFriendSvg = () => (
  <div className="flex gap-[12px] h-full items-center justify-center -ml-[30px]">
    ...
    <svg width="110" height="110" viewBox="0 0 126 126" fill="none" className="-ml-[45px] mt-[40px]">
      <rect x="0.25" y="0.25" width="125.5" height="125.5" rx="62.75" fill="white"/>
...
const FamilySvg = () => (
  <div className="flex items-center justify-center relative w-[190px] h-[140px]">
    {/* Parent 1 (Left) */}
    <svg width="90" height="90" viewBox="0 0 126 126" fill="none" className="absolute left-[10px] top-[10px] z-10">
      <rect x="0.25" y="0.25" width="125.5" height="125.5" rx="62.75" fill="white"/>
    ...
    {/* Parent 2 (Right) */}
    <svg width="90" height="90" viewBox="0 0 126 126" fill="none" className="absolute right-[10px] top-[10px] z-10">
      <rect x="0.25" y="0.25" width="125.5" height="125.5" rx="62.75" fill="white"/>
    ...
    {/* Baby (Middle) */}
    <svg width="65" height="65" viewBox="0 0 126 126" fill="none" className="absolute left-1/2 -translate-x-1/2 bottom-[10px] z-20">
      <rect x="0.25" y="0.25" width="125.5" height="125.5" rx="62.75" fill="white"/>
...
export default function CaredFor() {
  return (
    <section className="bg-[#FDF0CB] w-full flex flex-col items-center justify-center pt-[80px] pb-[124px] relative border-t-0">
      ...
      <div className="max-w-[1280px] mx-auto w-full flex flex-col items-center gap-[44px] px-[10px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[16px] w-full">
          {cards.map((card, index) => (
            <div
              key={index}
              className={`${card.bg} flex flex-col items-center justify-between p-[24px] rounded-[22px] min-h-[313px] drop-shadow-none`}
            >
              <div className="flex h-[195px] w-full justify-center items-center shrink-0">
                <card.Illustration />
              </div>
